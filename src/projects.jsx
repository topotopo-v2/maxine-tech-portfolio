...
Proactively improved Android codebase maintainability during downtimes through continuous refactoring, reducing code duplications.

Implemented architectural refactoring between two modules by decoupling shared dependencies and which improved maintainability and reduced ABI build times by ~20 seconds.
...
`,
...

    {
        ...
        position:
            "Application Consultant at Optimum Solutions (UOB Project)",
...
Developed key engagement features for UOB TMRW as part of the Engagement Team, including real-time Expense Tracking and dynamic Polling/Surveys. Investigated and resolved region-specific bugs for UOB TMRW App, targeting users in Thailand and Indonesia, improving stability and user experience.`,
...

    {
        ...
        techStack: "Android (Java), MVVM, Expoplayer",
